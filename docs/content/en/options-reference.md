...
Configuration for the `vue-i18n` library that is used internally but this module. See full documentation at [http://kazupon.github.io/vue-i18n/api/#constructor-options](http://kazupon.github.io/vue-i18n/api/#constructor-options)
